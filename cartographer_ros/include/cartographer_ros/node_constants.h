...
constexpr char kLocalizationScoreTopic[] = "localization_score";
constexpr char kOptimizeSubmapPoseTopic[] = "corrected_submap_entry";
constexpr char kTransformTopic[] = "base_link_pose";
